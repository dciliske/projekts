...
var drawArcedArrow=function(ctx,x,y,r,startangle,endangle,anticlockwise,style,which,angle,d,width)
{
    'use strict';
...
var drawArrow=function(ctx,x1,y1,x2,y2,style,which,angle,d, width)
{
    'use strict';
